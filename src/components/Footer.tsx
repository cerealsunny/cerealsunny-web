...
export default function Footer() {
  ...
  return (
    <footer style={{ background: "#1B4F8A", width: "100%" }}>
      ...
      {/* Main content */}
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "64px 24px 48px" }}>
        <div style={{
          display: "grid",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "16px" }}>
              ...
              <div>
                <div style={{
                  ...
                  SUNNY<sup style={{ fontSize: "9px", color: "#F5A623", verticalAlign: "super" }}>®</sup>
                </div>
                <div style={{
                  fontSize: "9px",
                  letterSpacing: "0.2em",
      ...
      <div style={{
        ...
        <div style={{
          ...
          <a
            ...
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLAnchorElement).style.color = "rgba(147,197,253,0.55)";
            }}
          >
          ...
          <div style={{ display: "flex", gap: "24px" }}>
            {["Política de Privacidad", "Términos de Uso"].map((item) => (
              <a
                key={item}
                href="#"
                style={{ fontSize: "13px", color: "#93c5fd", textDecoration: "none" }}
                onMouseEnter={(e) => ((e.currentTarget as HTMLAnchorElement).style.color = "#F5A623")}
                onMouseLeave={(e) => ((e.currentTarget as HTMLAnchorElement).style.color = "#93c5fd")}
              >
                {item}
